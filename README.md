...
GOAL 1: As a beginner, the Maya interface has a lot of new tools. An example is the front facing camera image plane script. <b>This will help me or other beginners new to Maya when we can't remember where a tool is.</b>

GOAL 2: <b>Efficiency of tools themselves and interdependencies of tools to save time.</b> An example is the front view camera image plane tool script used for the following scenarios from class and outside class:
